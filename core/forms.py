...
class TrainingSignupForm(forms.ModelForm):
    ...
    def clean_phone(self):
        ...
        if not phone:
            raise forms.ValidationError(_("Вкажіть номер телефону."))
        return phone
...
class AcademySignupForm(forms.ModelForm):
    ...
    def clean_first_name(self):
        ...
        if not first_name:
            raise forms.ValidationError(_("Вкажіть імʼя."))
        return first_name
    ...
    def clean_consent(self):
        ...
        if not consent:
            raise forms.ValidationError(_("Потрібно підтвердити згоду на обробку даних."))
        return consent
